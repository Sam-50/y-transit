...
"[project]/src/app/dashboard/admin/drivers/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DriverManagementPage() {
    ...
    const handleAddDriver = async (event)=>{
        ...
        try {
            const newDriver = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$drivers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDriver"])(newDriverData);
            setDrivers((prev)=>[
                    ...prev,
                    newDriver
                ]);
    ...
    const handleEditDriver = async (event)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$drivers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDriver"])(selectedDriver.id, updatedData);
    ...
    const handleAssignRoute = async (event)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$drivers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDriver"])(selectedDriver.id, {
                route: assignedRoute
            });
            setDrivers(drivers.map((d)=>d.id === selectedDriver.id ? {
                    ...d,
    ...
    const handleToggleStatus = async (driver)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$drivers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDriver"])(driver.id, {
                status: newStatus
            });
...
//# sourceMappingURL=src_13db562b._.js.map