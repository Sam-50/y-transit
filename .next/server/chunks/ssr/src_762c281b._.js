...
function StudentManagementPage() {
    ...
    const [isAssignRouteOpen, setIsAssignRouteOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isParentDetailsOpen, setIsParentDetailsOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleAddStudent = async (event)=>{
        ...
        try {
            const newStudent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$students$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addStudent"])(newStudentData);
            setStudents((prev)=>[
                    ...prev,
                    newStudent
                ]);
    ...
    const handleEditStudent = async (event)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$students$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateStudent"])(selectedStudent.id, updatedData);
    ...
    const handleAssignRoute = async (event)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$students$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateStudent"])(selectedStudent.id, {
                route: newRoute
            });
            setStudents(students.map((s)=>s.id === selectedStudent.id ? {
                    ...s,
...
//# sourceMappingURL=src_762c281b._.js.map