...
function LoginPage() {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('admin');
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (user) {
                ...
                const userRole = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserRole"])(user.email);
                ...
                if (userRole === activeTab) {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"].signOut(); // Sign out the user if role doesn't match
                    toast({
                        variant: "destructive",
                        title: "Access Denied",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__684b1c85._.js.map