...
;
;
// The admin role is hardcoded for simplicity.
const ADMIN_EMAILS = [
...
const getUserRole = async (email)=>{
    ...
    if (await getDriverData(email)) {
        return 'driver';
    }
    if (await getParentData(email)) {
        return 'parent';
    }
    return null;
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82760a8c._.js.map