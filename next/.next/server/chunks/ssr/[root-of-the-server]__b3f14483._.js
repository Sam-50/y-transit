...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (user && user.email) {
                // 2. Verify the user's role from your database
                ...
                // 3. Check if the role matches the selected tab
                if (userRole === activeTab) {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"].signOut(); // Log out the user if role is incorrect
                    toast({
                        variant: "destructive",
                        title: "Login Failed",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3f14483._.js.map