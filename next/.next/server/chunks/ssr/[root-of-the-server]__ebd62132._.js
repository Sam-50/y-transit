...
const getUserRole = async (email)=>{
    ...
    const driverQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(driversCol, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('email', '==', email));
    const driverSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDocs"])(driverQuery);
    ...
    const parentQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(studentsCol, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('parent.email', '==', email));
    const parentSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDocs"])(parentQuery);
    if (!parentSnapshot.empty) {
        return 'parent';
    }
    // If not a driver or parent, assume admin.
    // In a production app, you might have an 'admins' collection or use custom claims.
    return 'admin';
};
}}),
...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (userRole !== role) {
                throw new Error(`You are not registered as a ${role}. Please select the correct role.`);
            }
            toast({
            ...
            if (error instanceof Error && error.message.includes('You are not registered')) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ebd62132._.js.map