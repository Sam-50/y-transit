...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (user && user.email) {
                // Step 2: Verify the user's role from the database
                ...
                // Step 3: Enforce that the role matches the login form used
                if (userRole === activeTab) {
                    ...
                    toast({
                        variant: "destructive",
                        title: "Access Denied",
                        description: userRole ? `You do not have permission to access the ${activeTab} dashboard.` : "You do not have a role assigned. Please contact an administrator."
                    });
                }
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f1089757._.js.map