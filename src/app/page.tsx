...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const superUsers = [
        { email: "sam.k.kiptoo@gmail.com", password: "Yellow200%" },
        { email: "cyprian@yellowtransit.com", password: "Yellow300%" },
        { email: "cynthia@yellowtransit.com", password: "Yellow400%" },
        { email: "oka@yellowtransit.com", password: "Yellow500%" },
      ];
      ...
      const isSuperUser = superUsers.some(
        (user) =>
          ...
          ["admin", "parent", "driver"].includes(role)
      );
  ...
  return (
    ...
    >
      ...
      <Card className="w-full max-w-sm z-10 backdrop-blur-sm bg-white/90">
